        ...
        <section className='min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between dark:text-white'>
            ...
            <ul className='flex items-center'>
              ...
              <li>
                <a download='./atamurad-res.docx' className='bg-gradient-to-r from-cyan-500 text- to-teal-500 text-white px-4 py-2 border-none rounded-md ml-8' href='#'>
                  Download Resume
                </a>
              </li>
            </ul>
          ...
          <div className='text-center p-10 py-10'>
            <h2 className='text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl'>Atamurad Babakulyyev</h2>
            <h3 className='text-2xl py-2 dark:text-white md:text-3xl'>Full stack developer.</h3>
